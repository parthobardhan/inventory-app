...
function initializeEventListeners() {
    ...
    closeMobileModal.addEventListener('click', closeMobileModal);
...
async function loadProducts() {
    try {
        ...
        const response = await fetch(`${API_BASE}/products?type=bed-covers`);
...
function generateSampleProducts() {
    return [
        {
            _id: 'sample-1',
            name: 'Classic Woven Cotton Quilt',
            description: 'Breathable cotton quilt with timeless geometric pattern. Perfect for year-round comfort.',
            price: 129.99,
            type: 'bed-covers',
            quantity: 15,
            images: [],
        ...
        {
            _id: 'sample-2',
            name: 'Luxurious Linen Duvet Cover',
            description: 'Premium European linen duvet cover with natural texture and sophisticated drape.',
            price: 189.99,
            type: 'bed-covers',
            quantity: 8,
            images: [],
        ...
        {
            _id: 'sample-3',
            name: 'Soft Cotton Blend Comforter',
            description: 'Hypoallergenic cotton blend comforter with cloud-like softness and temperature regulation.',
            price: 99.99,
            type: 'bed-covers',
            quantity: 22,
            images: [],
        ...
        {
            _id: 'sample-4',
            name: 'Organic Cotton Coverlet',
            description: 'GOTS-certified organic cotton coverlet with subtle texture and natural breathability.',
            price: 159.99,
            type: 'bed-covers',
            quantity: 12,
            images: [],
        ...
        {
            _id: 'sample-5',
            name: 'Navy Linen Bedspread',
            description: 'Deep navy linen bedspread with pre-washed softness and elegant drape.',
            price: 149.99,
            type: 'bed-covers',
            quantity: 6,
            images: [],
        ...
        {
            _id: 'sample-6',
            name: 'Textured Cotton Quilt Set',
            description: 'Three-piece cotton quilt set with matching pillow shams and decorative stitching.',
            price: 199.99,
            type: 'bed-covers',
            quantity: 9,
            images: [],
...
function createProductCard(product) {
    ...
    const imageHTML = imageUrl 
        ...
        : `<div class="product-image-placeholder"><span>Bed Cover</span></div>`;
    ...
    return `
        <div class="product-card" data-product-id="${product._id}">
            ...
            <div class="product-info">
                ...
                <p class="product-description">${(product.description || 'Premium bed cover crafted for comfort and style.').replace(/^["']|["']$/g, '')}</p>
...
function showQuickViewModal(product) {
    ...
    let description = product.description || 'Premium bed cover crafted for comfort and style. Machine-washable and designed to last.';
    ...
    if (product.images && product.images.length > 0) {
        ...
        if (!placeholder) {
            ...
            placeholder.textContent = 'Bed Cover Image';
...
function updateResultsCount() {
    ...
    if (count === total) {
        resultsCount.textContent = `Showing all ${count} bed covers`;
    } else {
        resultsCount.textContent = `Showing ${count} of ${total} bed covers`;
    }
}
