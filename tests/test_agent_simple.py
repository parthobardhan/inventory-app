"""
Simple test for the voice agent's view_analytics functionality.
...
class InventoryAssistant(Agent):
    def __init__(self):
        super().__init__(
            ...
            You can view sales analytics and profit statistics.
            
            Be conversational, friendly, and efficient. When the user asks about sales:
            1. Understand their intent (which time period they're asking about)
            2. Use the view_analytics tool with the appropriate period
